...
export const ui = {
  ...
  neteaseSongIdInput: document.getElementById('netease-song-id'),
  neteasePlaylistIdInput: document.getElementById('netease-playlist-id'),
  neteaseIdDownloadBtn: document.getElementById('netease-id-download'),
